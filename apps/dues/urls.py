...
urlpatterns = [
    ...
    path("staff/transactions/", views.transaction_ledger, name="transaction_ledger"),
    path("staff/transactions.csv", views.export_transactions, name="export_transactions"),
